...
execute as @e[type=minecraft:wandering_trader] run effect give @s minecraft:slowness 999999 2 true
execute as @e[type=minecraft:wandering_trader] run effect give @s minecraft:invisibility 999999 3 true
execute as @e[tag=aj.copper_golem.root] run function copper_golem:set_variant/alive
return 1